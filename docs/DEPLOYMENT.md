# Deployment Guide — IT-Stack ELASTICSEARCH
...
- DNS entry: elasticsearch.it-stack.lab → lab-db1
...
```sql
CREATE USER elasticsearch_user WITH PASSWORD 'CHANGE_ME';
CREATE DATABASE elasticsearch_db OWNER elasticsearch_user;
```
...
- Client ID: $Module
- Valid redirect URI: https://elasticsearch.it-stack.lab/*
- Web origins: https://elasticsearch.it-stack.lab
...
```bash
curl -I https://elasticsearch.it-stack.lab/health
```
