# Lab 05-06 — Production Deployment

**Module:** 05 — Elasticsearch search and log indexing  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-05-06.sh  
**Compose File:** docker/docker-compose.production.yml

## Objective

Deploy elasticsearch in production with HA, monitoring, backup, and DR.

## Prerequisites

- Labs 05-01 through 05-05 pass
