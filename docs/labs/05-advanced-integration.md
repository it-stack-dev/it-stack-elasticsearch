# Lab 05-05 — Advanced Integration

**Module:** 05 — Elasticsearch search and log indexing  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-05-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect elasticsearch to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 05-01 through 05-04 pass
